...
$.extend( $.validator, {
	...
	prototype: {
		...
		check: function( element ) {
			...
			for ( method in rules ) {
				...
				try {
					...
					//console.log(['check for try ', result]);
					...
					if ( !result ) {
						...
						//console.log(['check for try !result', rule]);
		...
		showLabel: function( element, message ) {
			...
			//console.log(['showLabel: function( element', element]);
			...
			//console.log(['this.errorsFor( element )', error]);
		...
		errorsFor: function( element ) {
			//console.log(['errorsFor element', element]);
